...
public class MeuIphone {
    public static void main(String[] args) throws Exception {
        ...
        reprodutor.adicionarMusica("Imagine", "John Lennon", 197, 1971);
        reprodutor.adicionarMusica("Billie Jean", "Michael Jackson", 296, 1983);
        reprodutor.mostrarLista();
        reprodutor.excluirMusica("Shape of You");
        reprodutor.mostrarLista();
        reprodutor.comecarMusica("Bohemian Rhapsody");
